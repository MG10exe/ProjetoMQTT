...
def atualizar_imagem(estado):
   if estado == "ligada":
       img = ImageTk.PhotoImage(Image.open("/home/ifpb/Documentos/MQTT/imgs/lampada_ligada.png"))
   else:
       img = ImageTk.PhotoImage(Image.open("/home/ifpb/Documentos/MQTT/imgs/lampada_desligada.png"))
...
img_desligada = ImageTk.PhotoImage(Image.open("/home/ifpb/Documentos/MQTT/imgs/lampada_desligada.png"))
